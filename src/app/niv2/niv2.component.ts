...
@Component({
  selector: 'app-niv2',
  templateUrl: './niv2.component.html',
  styleUrls: ['./niv2.component.css']
})
export class Niv2Component {
  ...
  constructor(
    ...
    this.etudiants = [];
    this.etudiantsToDisplay = this.etudiants.filter(etudiant => etudiant.niveau === 'niveau 2');
  ...
  async generatePdf() {
    ...
    if (element) {
      ...
      doc.addImage(imageData, 'PNG', 15, 25 , canvas.width*0.13, canvas.height *0.13); 
    }
